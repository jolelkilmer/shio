...
class ShObjectAPITest {
  ...
  void shObjectMoveToFolder() throws Exception {
    ...
    RequestBuilder moveRequestBuilder =
        MockMvcRequestBuilders.put("/api/v2/object/moveto/" + shFolderHome.getId())
            .principal(mockPrincipal)
            .accept(MediaType.APPLICATION_JSON)
            .content(objectIdsRequestBody)
            .contentType("application/json");
  ...
  void shObjectMoveToSite() throws Exception {
    ...
    RequestBuilder moveRequestBuilder =
        MockMvcRequestBuilders.put("/api/v2/object/moveto/" + shSite.getId())
            .principal(mockPrincipal)
            .accept(MediaType.APPLICATION_JSON)
            .content(objectIdsRequestBody)
            .contentType("application/json");
  ...
  void shObjectCopyToFolder() throws Exception {
    ...
    RequestBuilder moveRequestBuilder =
        MockMvcRequestBuilders.put("/api/v2/object/copyto/" + shFolderHome.getId())
            .principal(mockPrincipal)
            .accept(MediaType.APPLICATION_JSON)
            .content(objectIdsRequestBody)
            .contentType("application/json");
  ...
  void shObjectCopyToSite() throws Exception {
    ...
    RequestBuilder moveRequestBuilder =
        MockMvcRequestBuilders.put("/api/v2/object/copyto/" + shSite.getId())
            .principal(mockPrincipal)
            .accept(MediaType.APPLICATION_JSON)
            .content(objectIdsRequestBody)
            .contentType("application/json");
  ...
  void shObjectPreviewSite() throws Exception {
    ShSite shSite = shSiteRepository.findByName("Viglet");
    mockMvc
        .perform(get("/api/v2/object/" + shSite.getId() + "/preview"))
  ...
  void shObjectPreviewFolder() throws Exception {
    ...
    ShFolder shFolderHome = shFolderRepository.findByShSiteAndName(shSite, "Home");
    mockMvc
        .perform(get("/api/v2/object/" + shFolderHome.getId() + "/preview"))
        .andExpect(status().is3xxRedirection());
  }
  ...
  void shObjectPreviewPost() throws Exception {
    ...
    mockMvc
        .perform(get("/api/v2/object/" + shPost.getId() + "/preview"))
        .andExpect(status().is3xxRedirection());
  }
  ...
  void shObjectListItemSite(String path) throws Exception {
    ShSite shSite = shSiteRepository.findByName("Viglet");
    mockMvc
        .perform(get("/api/v2/object/" + shSite.getId() + path))
  ...
  void shObjectListItemFolder() throws Exception {
    ...
    ShFolder shFolderHome = shFolderRepository.findByShSiteAndName(shSite, "Home");
    mockMvc
        .perform(get("/api/v2/object/" + shFolderHome.getId() + "/list"))
        .andExpect(status().isOk())
        .andExpect(content().contentType("application/json"));
  }
  ...
  void shFolderListByPostTypeSite() throws Exception {
    ShSite shSite = shSiteRepository.findByName("Viglet");
    mockMvc
        .perform(get("/api/v2/object/" + shSite.getId() + "/list/Text"))
        .andExpect(status().isOk())
        .andExpect(content().contentType("application/json"));
  }
  ...
  void shObjectPathPost() throws Exception {
    ...
    ShPost shPost = shPostRepository.findByShFolderAndFurl(shFolderHome, "index");
    mockMvc
        .perform(get("/api/v2/object/" + shPost.getId() + "/path"))
        .andExpect(status().isOk())
        .andExpect(content().contentType("application/json"));
  }
}
