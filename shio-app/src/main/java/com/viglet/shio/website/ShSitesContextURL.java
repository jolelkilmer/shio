...
public class ShSitesContextURL implements Serializable {
  ...
  public String toString() {
    return String.format(
        "shContext: %s, contextURL: %s, shContextOriginal: %s, siteId: %s, parentFolderId: %s,"
            + " shFormat: %s, shLocale: %s, objectId:  %s",
        info.getShContext(),
        info.getContextURL(),
        info.getContextURLOriginal(),
        info.getSiteId(),
        info.getParentFolderId(),
        info.getShFormat(),
        info.getShLocale(),
        info.getObjectId());
  }
