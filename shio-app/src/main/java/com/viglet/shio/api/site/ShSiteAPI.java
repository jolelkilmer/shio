...
public class ShSiteAPI {
  ...
  @Autowired private ShSiteExport shSiteExport;
  @Autowired private ShSitesNodeJS shSitesNodeJS;
  @Autowired private ShCloneExchange shCloneExchange;
  @Autowired private ShHistoryUtils shHistoryUtils;
  @Autowired private ShReportPostType shReportPostType;
  ...
  @PutMapping("/{id}")
  @JsonView({ShJsonView.ShJsonViewObject.class})
  public ShSite shSiteUpdate(
      @PathVariable String id, @RequestBody ShSite shSite, Principal principal) {
