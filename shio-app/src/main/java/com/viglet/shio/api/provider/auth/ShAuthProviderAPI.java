...
public class ShAuthProviderAPI {
  ...
  @Autowired private ShAuthProviderVendorRepository shAuthProviderVendorRepository;
  @Autowired private ShConfigVarRepository shConfigVarRepository;
  @Autowired private ShAuthProviderService shAuthProviderService;
  ...
  @PostMapping
  @JsonView({ShJsonView.ShJsonViewObject.class})
  public ShAuthProviderInstanceBean shAuthProviderInstanceAdd(
    ...
    for (Entry<String, String> propertyEntry :
        shAuthProviderInstanceBean.getProperties().entrySet()) {
  ...
  @PutMapping("/{id}")
  @JsonView({ShJsonView.ShJsonViewObject.class})
  public ShAuthProviderInstanceBean shAuthProviderInstanceUpdate(
      @PathVariable String id, @RequestBody ShAuthProviderInstanceBean shAuthProviderInstanceBean) {
    Optional<ShAuthProviderInstance> shAuthProviderInstanceOptional =
        shAuthProviderInstanceRepository.findById(id);
    if (shAuthProviderInstanceOptional.isPresent()) {
      ...
      for (Entry<String, String> propertyEntry :
          shAuthProviderInstanceBean.getProperties().entrySet()) {
        String providerInstancePath =
            String.format(shConfigProperties.getAuth(), shAuthProviderInstanceEdit.getId());
  ...
  public boolean shAuthProviderInstanceDelete(@PathVariable String id) {
    Optional<ShAuthProviderInstance> shAuthProviderInstance =
        shAuthProviderInstanceRepository.findById(id);
  ...
  @PutMapping("/sort")
  @JsonView({ShJsonView.ShJsonViewObject.class})
  public Map<String, Integer> shAuthProviderInstanceSort(
    ...
    for (Entry<String, Integer> objectOrderItem : objectOrder.entrySet()) {
      ...
      Optional<ShAuthProviderInstance> shAuthProviderInstanceOptional =
          shAuthProviderInstanceRepository.findById(shAuthProviderId);
      if (shAuthProviderInstanceOptional.isPresent()) {
