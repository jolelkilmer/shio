...
public interface ShObjectRepository extends JpaRepository<ShObject, String> {
  ...
  int countByIdAndShGroupsInOrIdAndShUsersInOrIdAndShGroupsIsNullAndShUsersIsNull(
      String id, Collection<String> groups, String id2, Collection<String> users, String id3);
