 ...
 */
@Repository
public interface ShPostDraftAttrRepository
    extends JpaRepository<ShPostDraftAttr, String>, JpaSpecificationExecutor<ShPostDraftAttr> {
  ...
  @Query(
      "select p from ShPostDraftAttr p JOIN FETCH p.shPostTypeAttr where p.shParentRelatorItem ="
          + " ?1")
