...
public class ShCloneExchange {
  ...
  public ShExchangeData getTemplateAsCloneFromMultipartFile(
      MultipartFile multipartFile, ShSite shSite) {
  ...
  private ShExchange changeObjectIdsFromExportToClone(
      ShSite shSite, ShExchangeFilesDirs shExchangeFilesDirs) {
  ...
  private boolean hasPostTypes(ShExchange shExchange) {
    return shExchange != null
        && shExchange.getPostTypes() != null
        && !shExchange.getPostTypes().isEmpty();
  }
