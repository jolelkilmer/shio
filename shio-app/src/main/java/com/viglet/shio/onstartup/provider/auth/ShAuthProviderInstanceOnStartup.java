...
public class ShAuthProviderInstanceOnStartup {
  ...
  private void createEmbeddedInstance() {
    ...
    shAuthProviderInstance.setVendor(
        shAuthProviderVendorRepository.findById(ShAuthSystemProviderVendor.NATIVE).orElse(null));
  ...
  private void createOTDSInstance() {
    ...
    shAuthProviderInstance.setVendor(
        shAuthProviderVendorRepository.findById(ShAuthSystemProviderVendor.OTDS).orElse(null));
    ...
    this.createAttribute(
        shAuthProviderInstance.getId(), ShOTDSService.RESOURCE_ID, "enter-otds-resource-id");
    this.createAttribute(
        shAuthProviderInstance.getId(), ShOTDSService.SECRET_KEY, "enter-otds-secret-key");
