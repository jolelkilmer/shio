...
public class ShLocaleOnStartup {
  @Autowired private ShLocaleRepository shLocaleRepository;
  ...
  public void createDefaultRows() {
    ...
    if (shLocaleRepository.findAll().isEmpty()) {
      ...
      shLocaleRepository.save(
          new ShLocale("ca", "Català - Catalan (beta)", "Català - Catalão (beta)"));
      ...
      shLocaleRepository.save(
          new ShLocale("en-gb", "English UK - British English", "English UK - Inglês britânico"));
      ...
      shLocaleRepository.save(
          new ShLocale("id", "Bahasa Indonesia - Indonesian", "Bahasa Indonesia - Indonésio"));
      ...
      shLocaleRepository.save(
          new ShLocale("msa", "Bahasa Melayu - Malay", "Bahasa Melayu - Malaio"));
      ...
      shLocaleRepository.save(
          new ShLocale("pt-pt", "Português - Portuguese (Portugal)", "Português (Portugal)"));
      shLocaleRepository.save(
          new ShLocale("pt-br", "Português - Portuguese (Brazil)", "Português (Brasil)"));
      ...
      shLocaleRepository.save(
          new ShLocale("uk", "Українська мова - Ukrainian", "Українська мова - Ucraniano"));
      shLocaleRepository.save(new ShLocale("ur", "اردو - Urdu", "اردو - Urdu"));
      shLocaleRepository.save(
          new ShLocale("vi", "Tiếng Việt - Vietnamese", "Tiếng Việt - Vietnamita"));
      shLocaleRepository.save(new ShLocale("xx-lc", "LOLCATZ - Lolcat", "LOLCATZ - Lolcat"));
      shLocaleRepository.save(
          new ShLocale("zh-cn", "简体中文 - Simplified Chinese", "简体中文 - Chinês simplificado"));
      shLocaleRepository.save(
          new ShLocale("zh-tw", "简体中文 - Traditional Chinese", "繁體中文 - Chinês tradicional"));
    }
  }
}
