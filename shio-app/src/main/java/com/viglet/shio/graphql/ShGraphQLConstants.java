...
public final class ShGraphQLConstants {
  ...
  public static final GraphQLEnumType stageEnum =
      newEnum()
          .name(STAGE_ARG_TITLE)
          .description("Stage system enumeration")
          .value("PUBLISHED", 10, "System Published Stage.")
          .value("DRAFT", 20, "System Draft Stage")
          .comparatorRegistry(BY_NAME_REGISTRY)
          .build();

  public static final GraphQLEnumType localeEnum =
      newEnum()
          .name(LOCALES_ARG_TITLE)
          .description("Locale system enumeration")
          .value("en", "EN", "System Locale.")
          .comparatorRegistry(BY_NAME_REGISTRY)
          .build();
