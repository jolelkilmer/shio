...
public class ShDefaultGraphQLInvocation implements GraphQLInvocation {
  ...
  @Autowired ExecutionInputCustomizer executionInputCustomizer;

  @Autowired ShGraphQLSchema shGraphQLSchema;

  @Override
  public CompletableFuture<ExecutionResult> invoke(
      GraphQLInvocationData invocationData, WebRequest webRequest) {
    ...
    CompletableFuture<ExecutionInput> customizedExecutionInput =
        executionInputCustomizer.customizeExecutionInput(executionInput, webRequest);
